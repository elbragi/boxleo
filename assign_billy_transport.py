        ...
        try:
            while True:
                ...
                if not password_sent and ("password:" in log.lower()):
                    ...
                    print("[AI] Assigning Billy as manager of Transport & Logistics...")
                    os.write(fd, b"php artisan tinker --execute=\"App\\\\Models\\\\User::find(35)->managerDepartments()->syncWithoutDetaching([8]); echo 'Done';\"\n")
                    time.sleep(5)
