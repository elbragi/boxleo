        ...
        try:
            while True:
                ...
                if not password_sent and ("password:" in log.lower()):
                    ...
                    print("[AI] Fetching latest changes from GitHub...")
                    os.write(fd, b"git fetch origin main\n")
                    time.sleep(2)
                    
                    print("[AI] Resetting to origin/main (force update)...")
                    os.write(fd, b"git reset --hard origin/main\n")
                    time.sleep(2)
                    
                    print("[AI] Cleaning untracked files...")
                    os.write(fd, b"git clean -fd\n")
                    time.sleep(2)
